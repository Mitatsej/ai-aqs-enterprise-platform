...
The current pipeline runs raw-to-Bronze ingestion followed by Bronze-to-Silver
validation and transformation. Gold aggregation, scoring, risk classification,
and recommendations will be added in later phases.
"""
